...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/CourierBoldObliqueWidths.gperf  */
...
CourierBoldObliqueWidthsLookup (register const char *str, register unsigned int len)
{
