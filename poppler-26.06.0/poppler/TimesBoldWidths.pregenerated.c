...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/TimesBoldWidths.gperf  */
...
TimesBoldWidthsLookup (register const char *str, register unsigned int len)
{
