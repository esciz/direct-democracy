...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/TimesRomanWidths.gperf  */
...
TimesRomanWidthsLookup (register const char *str, register unsigned int len)
{
