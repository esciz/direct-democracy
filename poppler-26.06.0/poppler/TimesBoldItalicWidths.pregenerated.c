...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/TimesBoldItalicWidths.gperf  */
...
TimesBoldItalicWidthsLookup (register const char *str, register unsigned int len)
{
