...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/CourierBoldWidths.gperf  */
...
CourierBoldWidthsLookup (register const char *str, register unsigned int len)
{
