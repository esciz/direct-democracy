...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/CourierWidths.gperf  */
...
CourierWidthsLookup (register const char *str, register unsigned int len)
{
