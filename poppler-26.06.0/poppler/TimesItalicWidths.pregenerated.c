...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/TimesItalicWidths.gperf  */
...
TimesItalicWidthsLookup (register const char *str, register unsigned int len)
{
