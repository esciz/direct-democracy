...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchaingperf poppler/HelveticaWidths.gperf  */
...
HelveticaWidthsLookup (register const char *str, register unsigned int len)
{
