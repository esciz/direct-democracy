...
export default async function VotingPage({ searchParams }: VotingPageProps) {
  ...
  return (
    <div className="relative mx-auto max-w-4xl space-y-5 overflow-hidden pb-10 pt-2 sm:pt-4">
      <div className="pointer-events-none absolute inset-x-[-12%] top-0 -z-10 h-72 bg-[radial-gradient(circle_at_top,rgba(14,165,233,0.18),transparent_45%),radial-gradient(circle_at_top_right,rgba(245,158,11,0.16),transparent_38%),radial-gradient(circle_at_top_left,rgba(16,185,129,0.12),transparent_36%)]" />
      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-[linear-gradient(155deg,rgba(255,255,255,0.97),rgba(247,250,252,0.92))] p-6 shadow-[0_26px_60px_-38px_rgba(15,23,42,0.72)] backdrop-blur sm:p-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(14,165,233,0.16),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(245,158,11,0.12),transparent_32%)]" />
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="relative">
            <div className="inline-flex items-center gap-2 rounded-full border border-civic-200/70 bg-civic-50/80 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-civic-700">
              <span>Weekly civic pulse</span>
            </div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight text-ink">VOTE</h1>
        ...
        <div className={`relative mt-5 rounded-[1.5rem] border px-4 py-3 text-sm shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] ${verified ? "border-slate-200 bg-white/80 text-slate-700" : "border-orange-200 bg-orange-50 text-orange-900"}`}>
          {verified
