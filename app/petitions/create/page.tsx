  ...
  return (
    <div className="space-y-6 py-8">
      <PageIntro
        ...
        description={
          organization?.canManage && organization.organizationType === "coalition"
            ? `Publish a coalition petition for ${organization.name}. Signature eligibility and co-sponsorship are tracked automatically.`
      ...
      <PetitionCreateForm
        ...
        error={params?.error}
        organization={organization?.canManage && organization.organizationType === "coalition" ? organization : null}
