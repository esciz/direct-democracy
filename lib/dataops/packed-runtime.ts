...
export const PACKED_CIVIC_FILES = [
  "public-meeting-votes.json", "nevada-community-relationships.json", "voting-cards.json",
  "nevada-political-ads.json", "projects-runtime.json", "public-cases-runtime.json",
] as const;
