...
const seededNotifications: NotificationSummary[] = [
  ...
  {
    id: "notification_seeded_nearby_event_alicia",
    userId: "user_citizen_alicia_hart",
    type: "nearbyEvent",
    title: "New nearby event: Carson City Budget Forum",
    body: "A new civic meeting was added near you. Review the agenda and decide whether to attend.",
    entityId: "event_carson_budget_forum",
    contextEntityId: null,
    isRead: false,
    createdAt: "2026-04-07T08:00:00.000Z",
  },
  {
    id: "notification_seeded_event_reminder_marco",
    userId: "user_trusted_citizen_marco_silva",
    type: "eventReminder",
    title: "Event reminder: Support Carson Teachers Rally",
    body: "This event starts within the next 24 hours.",
    entityId: "event_carson_teacher_rally",
    contextEntityId: "24h",
    isRead: false,
    createdAt: "2026-04-07T09:00:00.000Z",
  },
  {
    id: "notification_seeded_event_live_alicia",
    userId: "user_citizen_alicia_hart",
    type: "eventLive",
    title: "Event live now: Support Carson Teachers Rally",
    body: "This event is happening now.",
    entityId: "event_carson_teacher_rally",
