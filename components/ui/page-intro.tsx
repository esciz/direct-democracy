...
export function PageIntro({ eyebrow, title, description, actions, meta, visual }: PageIntroProps) {
  ...
  return (
    <section className="dd-panel relative z-10 overflow-visible rounded-[1.9rem] p-6 sm:p-8">
      <div className="pointer-events-none absolute inset-0 [border-radius:inherit] bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.12),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(52,211,153,0.08),transparent_32%)]" />
